  ...
  <div class="home">
    ...
    <template v-else>
      <div class="van-box infoBox">
        <van-grid :column-num="3">
          <van-grid-item>
            ...
            <p class="text">
               <div  class="cl_type van-ellipsis">   {{entity.createTime}}</div>
              </p>
          </van-grid-item>
          <van-grid-item>
          ...
          <van-grid-item>
            <p class="title">违规类别</p>
            <p class="text">
              <div  class="cl_type van-ellipsis">{{entity.punishName}}</div>
              </p>
          </van-grid-item>
        </van-grid>
      </div>
      ...
      <van-tabs v-model="active" animated>
        <van-tab title="处理记录">
          <div class="cl_Content" v-for="item in entity.complaintRecordVos">
             <van-row class="card_time_line">
                ...
                <van-col span="21" icon=""> {{item.createTime}} </van-col>
              </van-row>
            <div class="card_box">
              <van-row>
                <van-col span="3" icon="">
        ...
        <van-tab title="信息详情">
          ...
          <van-row class="cl_conDrow" type="flex" justify="space-between">
            <van-col class="cl_conName" span="6" offset="2">违规地点</van-col>
            <van-col class="cl_conValue" span="8" offset="">{{entity.address}}</van-col>
          </van-row>

          <van-row class="cl_conDrow" type="flex" justify="space-between">
            <van-col class="cl_conName" span="6" offset="2">归属管辖</van-col>
            <van-col class="cl_conValue" span="8" offset="">{{entity.regionName}}</van-col>
          </van-row>
   
          <van-row class="cl_conDrow" type="flex" justify="space-between">
            <van-col class="cl_conName" span="6" offset="2">违规日期</van-col>
            <van-col class="cl_conValue" span="8" offset="">{{entity.createTime}}</van-col>
          </van-row>
   
          <van-row class="cl_conDrow" type="flex" justify="space-between">
            <van-col class="cl_conName" span="6" offset="2">违规来源</van-col>
            <van-col class="cl_conValue" span="8" offset="">
          ...
          <van-row class="cl_conDrow" type="flex" justify="space-between">
            ...
            <van-col class="cl_conValue" span="8" offset="">{{entity.punishName}}</van-col>
          </van-row>
